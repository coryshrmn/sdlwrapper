...
#if (SDL_MAJOR_VERSION > 2 || SDL_MAJOR_VERSION == 2 && SDL_MINOR_VERSION > 0 || SDL_MAJOR_VERSION == 2 && SDL_MINOR_VERSION == 0 && SDL_PATCHLEVEL >= 4)
    #define SDLWRAPPER_AUDIO_SUPPORTS_NONCALLBACK
#endif
